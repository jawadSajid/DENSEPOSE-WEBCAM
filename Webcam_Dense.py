...
def main(args):
	...
	iuvout, indsout = vis_utils.vis_webcam(im, cls_boxes, cls_segms, cls_keyps, cls_bodys, thresh=0.9, kp_thresh=2,
                dataset=dummy_coco_dataset, show_class=True)
